    ...
    return (
        <div className="flex flex-col space-y-4">
            <div className="flex space-x-3" >
                <label className="label w-half max-w-xs"><span className="label-text">Base API URL</span></label>
...
export function TokenDetailsInput(props){    
    return (
        <div className="flex flex-col space-y-4">
            <div className="flex space-x-3" >
                <label className="label"><span className="label-text">Token Type</span></label>
                <label className="label"><span className="label-text">{props.tokenType}</span></label>
            </div>
            <div className="flex space-x-3">
                <label className="label"><span className="label-text">Token ID</span></label>
            ...
            <div className="flex space-x-3" >
                <label className="label"><span className="label-text">Metadata Id</span></label>
            ...
            <div className="flex space-x-3">
            <label className="label"><span className="label-text">Contract Address</span></label>
